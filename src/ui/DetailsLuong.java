...
public class DetailsLuong extends javax.swing.JFrame {
	...
	private int rowL;
	public DetailsLuong(String maCN_L , int rowL) {
    	this.maCN_L = maCN_L;
    	this.rowL = rowL;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        String[] congDoanDTS=  {"Mã Công Đoạn", "Ngày chấm", "Số lượng"};
        ...
        docDuLieuDetailsLuong();
        
    }// </editor-fold>         
    
    
    
	private void docDuLieuDetailsLuong() {
...
//		for (CongDoanCN cd : congDoan_DAO.getCongDoanCongNhan(maCN_L)) {
//			
//			
//			Object[] rowData = { 
//					cd.getMaCongDoan(), 
...
//		}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailsLuong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new DetailsLuong().setVisible(true);
            }
        });
    }
